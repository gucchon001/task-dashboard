# 作成者でタスクを絞り込むスクリプト
# 使用方法: .\filter_tasks_by_author.ps1 [作成者名]
...
Write-Host ".\filter_tasks_by_author.ps1                    # 全作成者を表示"
Write-Host ".\filter_tasks_by_author.ps1 'Administrator'    # Administratorで絞り込み"
Write-Host ".\filter_tasks_by_author.ps1 'WIN-ND0QPM2D7G1' # 特定PCで絞り込み" 